...
useEffect(() => {
    const proidd = `category_name=Clothing&subcategory_name=Coat`;
...
useEffect(() => {
    const proid = `category_name=Clothing&subcategory_name=Coat`;
...
const itemsPerPage = 100; // Define itemsPerPage
  ...
  return (
   <>
    ...
    {errorMessage && ( // Render error message if present
        <div className="text-center mt-3">{errorMessage}</div>
      )}
