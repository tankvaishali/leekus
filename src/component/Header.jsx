...
function Header() {
        ...
        <nav className="z-2">
          <div className="d-flex align-items-center  justify-content-between">
            ...
            <div className=" d-lg-none d-block mt-2">
              ...
              <Link to={"/cartadd"} className="text-black fs-4" style={{ position: 'relative', display: 'inline-block' }}>
                <IoBagHandle className="text-white fs-4" />
              <span className=" prisefont wish_lengthnum rounded-circle text-white bg-danger d-flex justify-content-center align-content-center align-items-center  fw-bold p-1 fs-6"  style={{
  position: "absolute",
  top:" -4px",
  right:" -9px",
  width: "20px",
...
}}>{addtocart?.length>0 ?addtocart?.length:0}</span>
              </Link>
              <Link to={"/account"} className="text-decoration-none text-black mx-2">
        ...
        <li>
          ...
          <li className="dropdown ">
              ...
              <ul className="dropdown-menu">
                ...
                <li>
                <Link to={"/clothing/"+'Co-ords-Sets'}>Co-ords-Sets</Link>
                </li>
           ...
           <div className="">
            ...
            <button className="btn text-white border border-white px-5" style={{marginTop:'-5px',marginRight:'0px'}} type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop"> <IoSearch className="text-white"/>  search</button>
            {
              localStorage.getItem("user_id")&&<Link
              to={"/wishlist"}
              className="text-decoration-none text-black ms-3 text-white me-2"
              style={{ position: 'relative', display: 'inline-block' }}
            >
             
              <MdFavoriteBorder className="text-white fs-2" /><span className="wish_lengthnum rounded-circle text-white bg-danger d-flex justify-content-center prisefont align-content-center align-items-center  fw-bold p-1"  style={{
  position: "absolute",
  top:" -8px",
  right:" -9px",
  width: "20px",
  height: "20px",
            ...
            >
              ...
              <IoBagHandle className="text-white fs-4" />
              <span className=" prisefont wish_lengthnum rounded-circle text-white bg-danger d-flex justify-content-center align-content-center align-items-center  fw-bold p-1"  style={{
  position: "absolute",
  top:" -8px",
  right:" -9px",
  width: "20px",
        ...
        >
          ...
          <div className="offcanvas-body">
            ...
            <div className="accordion accordion-flush" id="accordionFlushExample">
              <div className="accordion-item text-black">
                ...
                >
                  <div className="accordion-body ps-4">
                    <div className="pb-1">
                      <Link to={"/clothingall"} className="offcanvasdesign text-black">
                        All
                      </Link>
                    </div>
                    <div className="py-2">
                    <Link to={"/clothing/"+'top'} className="offcanvasdesign text-black">
                        Top
                      </Link>
                    </div>
                   
                    <div className="py-2">
                    <Link to={"/clothing/"+'Pant'} className="offcanvasdesign text-black">
                    Pant & Trowzer
                      </Link>
                    </div>
                    <div className="py-2">
                    <Link to={"/clothing/"+'Shirt'} className="offcanvasdesign text-black">
                        Shirt
                      </Link>
                    </div>
                    <div className="py-2">
                    <Link to={"/clothing/"+'t-shirt'} className="offcanvasdesign text-black">
                        T-Shirt
                      </Link>
                    </div>
                    <div className="py-2">
                    <Link to={"/clothing/"+'Blazer'}
              ...
              <div className="border-bottom py-3 ps-4 ">
                <Link to={"/collectionrange"} className="text-decoration-none text-black">Collections</Link>
              </div>
           
              <div className="border-bottom py-3 ps-4 ">
                <Link to={"/contactus"} className="text-decoration-none text-black">Contact</Link>
              </div>
              <div className="border-bottom py-3 ps-4 ">
          ...
          <div className="container fw-bold fs-5 p-1 px-3  ">
            <Link to={"/account"} className="accordion offcanvasdesign d-flex align-items-center p-1 border-top">
             <span className="pe-1 pb-1 fw-medium"><FaRegUser/></span> Account
            </Link>
          </div>
        </div>
      </header>
  ...
  <div className="offcanvas offcanvas-top shadow-lg border border-2 border-dark mx-auto" data-bs-backdrop="false"  style={{ height: offcanvasHeight }}  data-bs-scroll="true"   tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
  <div className="offcanvas-header">
    <h5 className="offcanvas-title vw-100 " id="offcanvasTopLabel" > <input
                  type="text"
                  name="search"
                  placeholder="search..."
  ...
  <div className="offcanvas-body custom-offcanvas-body bg-white " >
            ...
            {filteredData?.map((x, id) => {
              ...
              <div key={id} className="col-12">
                  <Link to={`/productpurchase/${x.product_name}/${x.id}/${colorNames.colour_id}` } className="nav-link">   
